...
class TextFileClass {
	...
	public void getFileName(String prompt) {
		...
		return;
         ...
         //************************************************************************
	//Method:		getFileNamePassed
	//Description:	Gets the name of a text file that is passed by the program
	//Parameters:	passedName - passed name of the file wanting to be returned
	//Returns:		nothing
	//Throws		nothing
	//Calls:		nothing
	public void getFileNamePassed(String passedName) {
		fileName=passedName;
		return;
	}
	//************************************************************************
